...
export function Skills() {
  ...
  return (
    <div className="my-52 flex flex-col items-center">
      ...
      <div className="max-w-4xl flex gap-6 justify-between">
        <div className="shadow-black/20 transition-all  hover:outline cursor-pointer hover:outline-my-gold drop-shadow-lg py-2 px-4 items-center just bg-white rounded-lg flex flex-col">
        ...
        <div className="shadow-black/20 transition-all  hover:outline cursor-pointer hover:outline-my-blue drop-shadow-lg py-2 px-4 items-center just bg-white rounded-lg flex flex-col">
        ...
        <div className="shadow-black/20 transition-all  hover:outline cursor-pointer hover:outline-my-green drop-shadow-lg py-2 px-4 items-center just bg-white rounded-lg flex flex-col">
